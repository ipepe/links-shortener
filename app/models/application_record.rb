class ApplicationRecord < ActiveRecord::Base
  ...
  class << self
    ...
    def enum_with_string_values(enum_defs)
      enum_defs.keys.each do |enum_attribute_name|
        enum_defs[enum_attribute_name] = enum_defs[enum_attribute_name].each_with_object(Hash.new) do |enum_value, hash|
